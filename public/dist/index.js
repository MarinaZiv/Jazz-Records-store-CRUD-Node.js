...
var shopIcon = document.querySelector(".material-icons");
...
function handleSearch(e) {
    return __awaiter(this, void 0, void 0, function () {
        var input, data, error_6;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    input = e.target.value;
                    return [4 /*yield*/, axios.get("/albums/search?input=" + input)];
                case 1:
                    data = (_a.sent()).data;
                    renderToStore(data);
                    return [3 /*break*/, 3];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, axios.get("/albums/select-type?type=" + type)];
                case 2:
                    data = (_a.sent()).data;
                    renderToStore(data);
                    return [3 /*break*/, 4];
